  ...
  <div>
    <a 
      ...
      :class="[
        ...
        active ? 'bg-orange-500 text-white shadow-lg shadow-orange-500/30' : 'text-slate-600 hover:bg-slate-100'
      ]"
    >
      <component 
        :is="icon" 
      ...
      />
      <span class="ml-4 flex-1 text-sm font-semibold whitespace-nowrap">{{ text }}</span>
      <ChevronDown 
        v-if="hasSubmenu"
        :size="18" 
        :class="[
