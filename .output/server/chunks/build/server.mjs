...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-V--Eaoqf.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-D5UICb7i.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-BIPSVugz.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-6beWZwFf.mjs')
  },
  {
    name: "slide-manager",
    path: "/slide-manager",
    component: () => import('./slide-manager-zw47SAav.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DlLhDE_H.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CsLFv3-G.mjs'));
